...
jQuery(document).ready(function () {  
	...
	if (getURLParam('utm_source')) jQuery('.utm_source input').val(getURLParam('utm_source'));
	if (getURLParam('elqCampaignId')) jQuery('.elqCampaignId_gravity input').val(getURLParam('elqCampaignId'));
