		...
		PhishingTest.test = function(value){
			...
			if (PhishingTest.currentQuestion < 7){
				...
				jQuery.each(PhishingTest.TestItems, function (key, val) {
					...
					//var why_show = "<a href='/wp-content/uploads/2018/11/us_phishingiq_2_a" + key + ".png' target='_blank'>Why?</a>";
					var why_show = '<a href="/wp-content/uploads/2018/11/us_phishingiq_2_a'; 
						why_show1 = why_show + key + '.png" target="_blank">Why?</a>';
					var each_question = "<tr><td>" + key + "</td><td>" + PhishingTest.TestItems[key].subject + "</td><td>" + your_answer + "</td><td>" + correct_answer + "</td><td>" + result_check + "</td><td>" + why_show1 + "</td></tr>";
