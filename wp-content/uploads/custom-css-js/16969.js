...
function changeMode(){
	...
	jQuery("#row1 input").val(0);
	jQuery("#row2 input").val(0);
	jQuery("#row3 input").val(0);
	jQuery("#row4 input").val(0);
	jQuery("#row5 input").val(0);
	jQuery("#row6 input").val(0);
	jQuery("#row7 input").val(0);
