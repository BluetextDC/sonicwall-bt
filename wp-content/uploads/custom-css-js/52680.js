...
<script type="text/javascript">
	...
	var PhishingTest = new Object;
		...
		PhishingTest.TestItems = {
			...
			"3": {"subject": "OneDrive", "answer": "2", "test_answer": "0"},
		...
		PhishingTest.test = function(value){
			...
			if (PhishingTest.currentQuestion < 7){
              ...
              if(jQuery("#tblQuizResults tbody td").length > 0) {
                jQuery("#tblQuizResults tbody td").remove();
              }
...
//var why_show = "<a class='rs_popup' href='#div_answer_popup' onclick=\"select_answer_img('" + key + "')\" title='Why?' target='_blank'>Why?</a>";data-type='iframe' data-fancybox  
       const newUrl = window.location.origin+'/wp-content/uploads/2018/11/us_phishingiq_2_a' + key + '.png';
                  
					var why_show = "a href='"+newUrl+"' target='_blank' >Why?</a>";
