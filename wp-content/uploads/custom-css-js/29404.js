...
Saved: Feb 14 2019 | 04:23:44 */
    ...
    jQuery(document).on('gform_post_render',function() {
        ...
        jQuery('#banner-link').append('<span class="" style="top: 61px; width: 905px;"><span class="headline" style="color: #ffffff;">Get a great deal on deeper <br />network security </span><span class="subheadline" style="color: #ffffff;">Join the Dell Security Customer Advantage Program.</span><span class="action text" style="color: #ffffff;">Read Data Sheet<span>›</span></span></span>');
    });
