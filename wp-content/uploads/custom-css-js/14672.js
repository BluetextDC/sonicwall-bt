...
//pointer keeps a reference to the type node in product list
    ...
    jQuery(document).ready(function () {
                                    ...
                                    if (jQuery(this).find(arr[i][0]).length > 1) {//if more than one node with the same number of years
                                        jQuery(this).find(arr[i][0]).each(function () {
                                            ...
                                            if (jQuery('html').hasClass('ie8') || jQuery('html').hasClass('ie9')) {
                                                pricelist += ' <li><p>' + sku + ' - <span>' + jQuery(this).text() + '</span></p></li>';
                                            } else {
                                        ...
                                        pricelist += ' <li><p>' + sku + ' - <span>' + jQuery(this).find(arr[i][0]).text() + '</span> for ' + arr[i][1] + '</p></li>';
        ...
        jQuery('#banner-link').append('<span>\
        ...
        var a = "crs-country",
            ...
            i = function() {
                ...
                if ("true" !== c) {
                    ...
                    var s = $("." + r)[0];
                    if (s)
                        if (j(s), $(this).on("change", function() {
                                n(a, s)
                            }), i && a.selectedIndex > 0) {
                            n(a, s);
