	...
	<?php endif; ?>
        ...
        <div class="wpdreams-box" style="float:left;">
            ...
            <div tabid="1">
                ...
                "wpcf7_contact_form", "dslc_templates", "acf-field", "acf-group", "acf-groups", "custom_css")
                            )
                        ));
                    ?>
                </div>
                <fieldset id="it_file_indexing">
                    ...
                    <div class="item">
                        <?php $o = new wpdreamsTextarea("it_attachment_mime_types", __('Attachment mime types to index', 'ajax-search-pro'),
            ...
            <div tabid="2">
                ...
                <div class="item">
                    <?php $o = new wpdreamsTextarea("it_stopwords", __('Stop words list', 'ajax-search-pro'),
                ...
                <div class="item">
                    <?php $o = new wpdreamsTextarea("it_exclude_shortcodes", __('Remove these shortcodes', 'ajax-search-pro'),
