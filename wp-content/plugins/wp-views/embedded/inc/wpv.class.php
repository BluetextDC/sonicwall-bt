	...
	if ( $plugin_file == $this_plugin ) {
	    ...
	    if( wpv_is_views_lite() ){
		    $plugin_meta[] = sprintf(
			    ...
			    'https://wpml.org/version/views-lite-2-7-2/',
			    __( 'Views Lite 2.7.2 release notes', 'wpv-views' )
		    );
        } else {
		    $plugin_meta[] = sprintf(
			    '<a href="%s" target="_blank">%s</a>',
			    'https://toolset.com/version/views-2-7-2/?utm_source=viewsplugin&utm_campaign=views&utm_medium=release-notes-plugin-row&utm_term=Views 2.7.2 release notes',
			    __( 'Views 2.7.2 release notes', 'wpv-views' )
		    );
        }
