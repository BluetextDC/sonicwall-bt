...
function populateCountries(countryElementId, stateElementId){
	...
	if( stateElementId ){
		countryElement.onchange = function(){
			var selectedCountryIndex = document.getElementById( countryElementId ).selectedIndex;
			var selectedCountryName = country_arr[selectedCountryIndex -1];
			populateStates( countryElementId, stateElementId );
			if (selectedCountryName === 'USA') {
				jQuery('#sw-checkbox-electronic-msg-0').closest('.fb-checkbox-group').addClass("sw-hide");
			} else {
				jQuery('#sw-checkbox-electronic-msg-0').closest('.fb-checkbox-group').removeClass("sw-hide");
			}
		};
	}
	populateStates( countryElementId, stateElementId );
