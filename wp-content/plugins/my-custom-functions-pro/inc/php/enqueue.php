 ...
 */
function spacexchimp_p011_load_scripts_admin( $hook ) {

    // Put value of constants to variables for easier access
    $slug = SPACEXCHIMP_P011_SLUG;
    $prefix = SPACEXCHIMP_P011_PREFIX;
    $url = SPACEXCHIMP_P011_URL;
    ...
    // JavaScript
    wp_enqueue_script( $prefix . '-admin-js', $url . 'inc/js/admin.js', array(), $version, false );

}
add_action( 'admin_enqueue_scripts', 'spacexchimp_p011_load_scripts_admin' );
