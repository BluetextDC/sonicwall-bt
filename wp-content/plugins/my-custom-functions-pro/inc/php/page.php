...
function spacexchimp_p011_render_submenu_page() {
    ...
    $name = SPACEXCHIMP_P011_NAME;
    $slug = SPACEXCHIMP_P011_SLUG;
    $version = SPACEXCHIMP_P011_VERSION;
    $text = SPACEXCHIMP_P011_TEXT;

    // Call messages
    spacexchimp_p011_hello_message();
    spacexchimp_p011_successfull_message();
    spacexchimp_p011_parsing_error_message();

    // After settings updated backup all user entered snippets by calling the "backup" function
    if ( isset( $_GET['settings-updated'] ) ) {
        spacexchimp_p011_backup();
    }
    ...
    <div class="wrap">
        ...
        <div id="poststuff" class="metabox-holder has-right-sidebar">
            ...
            <ul class="tabs-nav">
                ...
                <li><a href="#tab-license" data-toggle="tab"><?php _e( 'License', $text ); ?></a></li>
            </ul>
            ...
            <div class="tab-page fade active in" id="tab-core">
                <!-- INCLUDE SIDEBAR -->
                <?php require_once( SPACEXCHIMP_P011_PATH . 'inc/php/sidebar.php' ); ?>
                <!-- INCLUDE SETTINGS -->
                <?php require_once( SPACEXCHIMP_P011_PATH . 'inc/php/settings.php' ); ?>

                <script type="text/javascript">
                    <?php require_once( SPACEXCHIMP_P011_PATH . 'inc/php/inline-js.php' ); ?>
                </script>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <ol class="custom-counter">
                            ...
                            <li><?php _e( 'Enter a title or a small description for the new function.', $text ); ?></li>
                            <li><?php _e( 'Place your PHP code in the field bellow. ', $text ); ?><br><br>
            ...
            <div class="tab-page fade" id="tab-faq">
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="answer-2"><?php _e( 'Yes. This plugin is ready for translation and has already been translated into several languages.', $text ); ?><br><br>
                                              <?php printf(
                                                            __( 'If you want to help translate this plugin then please visit the %s. You can also use the POT file, that is included and placed in the "languages" folder, in order to create a translation PO file. Just send the PO file to us at the %s and we will include this translation within the next plugin update.', $text ),
                                                                '<a href="https://translate.wordpress.org/projects/wp-plugins/my-custom-functions" target="_blank">translation page</a>',
                        ...
                        <div class="answer-3"><?php _e( 'On the "Main" tab, enter a title or a small description for the new function, place your PHP code in the field below, then switch the toggle to the "ON" position and click the "Save changes" button. Enjoy the result of applying your PHP code. It\'s that simple!', $text ); ?></div>
...
<pre><code>function NameOfYourFunction {
    ...
    echo "&lt;script&gt;
          ...
          &lt;/script&gt;";
                        ...
                        <div class="question-6"><?php _e( 'How much of fields I can create?', $text ); ?></div>
                        <div class="answer-6"><?php _e( 'We don\'t limit the number of fields.', $text ); ?></div>

                        <div class="question-7"><?php _e( 'Where I can find all created backups of my functions?', $text ); ?></div>
                        <div class="answer-7"><?php _e( 'All backups are located in the catalog <code>backups</code> (<code>/wp-content/plugins/my-custom-functions-pro/backups/</code>).', $text ); ?></div>

                        <div class="question-8 question-red"><?php _e( 'On the plugin settings page, an error message appears. What could be wrong?', $text ); ?></div>
                        <div class="answer-8"><?php _e( 'Here are a few of the most likely causes of the error message:', $text ); ?>
                                              <ol class="custom-counter">
                        ...
                        <div class="answer-10"><?php _e( 'This plugin can be configured with no knowledge of HTML or CSS, using an easy-to-use plugin settings page. But you need to know the HTML or CSS in order to add/remove/modify the HTML or CSS code by using this plugin.', $text ); ?></div>
                        ...
                        <div class="answer-12"><?php _e( 'This plugin has a built-in functions for checking the custom code for syntax errors, duplicate functions names, and etc. But plugin is not perfect, so there are times when the entered custom code causes the error and white screen (WSOD). This is due to the fact that your custom code has a syntax error that this plugin could not detect. When this happens with you, please perform the following steps.', $text ); ?>
                                              <ol class="custom-counter">
                                                  ...
                                                  <li><?php _e( 'Browse to the directory <code>wp-content/plugins/my-custom-functions-pro/</code>. Please contact your web hosting company to get help if you can\'t find this folder.', $text ); ?></li>
                                                  ...
                                                  <li><?php _e( 'Go to the plugin settings page <code>Settings</code> &#10145; <code>PHP Inserter PRO</code>.', $text ); ?></li>
                                              ...
                                              <?php _e( 'This plugin stored you entered code in the database of your website. For getting your code, you also can go to the <code>Database</code> &#10145; Table <code>wp_options</code> &#10145; Option <code>spacexchimp_p011_settings</code> &#10145; <code>option_value</code>.', $text ); ?>
                        ...
                        <div class="answer-17"><?php printf(
                                                            __( 'You can ask your question on %s this page %s. Please do not forget to specify the name of the plugin.', $text ),
                                                                '<a href="https://www.spacexchimp.com/contact.html" target="_blank">',
                                                                '</a>'
                                                           );
                                               ?></div>
            ...
            <!-- TAB 4 -->
            <div class="tab-page fade" id="tab-license">
                <?php require_once( SPACEXCHIMP_P011_PATH . 'inc/php/license.php' ); ?>
            </div>
            <!-- END-TAB 4 -->
