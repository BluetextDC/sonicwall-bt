 ...
 * @since 1.0.0
 */
function timeline_express_container_excerpt_styles( $field, $escaped_value, $object_id, $object_type, $field_type_object ) {
	...
	<label for="_timeline_styles_container_excerpt_styles[inherit]">

		<input type="checkbox" class="regular-text inherit-toggle" name="_timeline_styles_container_excerpt_styles[inherit]" id="_timeline_styles_container_excerpt_styles[inherit]" <?php checked( $inherit, true ); ?> value="1">
	...
	<p class="<?php echo esc_attr( $hidden ); ?> container-styles-holder">
		...
		<label for="_timeline_styles_container_excerpt_styles[size]">
			...
			<input class="widefat" name="_timeline_styles_container_excerpt_styles[size]" id="_timeline_styles_container_excerpt_styles[size]" type="number" placeholder="<?php echo esc_attr( $size ); ?>" value="<?php echo esc_attr( $size ); ?>" />

		</label>

		<label for="_timeline_styles_container_excerpt_styles[style]">

			<strong><?php esc_html_e( 'Font Style', 'timeline-express-pro' ); ?></strong>

			<?php

			print( '<select class="widefat" name="_timeline_styles_container_excerpt_styles[style]" id="_timeline_styles_container_excerpt_styles[style]">' );
		...
		<label for="_timeline_styles_container_excerpt_styles[font_weight]">

			<strong><?php esc_html_e( 'Font Weight', 'timeline-express-pro' ); ?></strong>

			<?php

			print( '<select class="widefat" name="_timeline_styles_container_excerpt_styles[font_weight]" id="_timeline_styles_container_excerpt_styles[font_weight]">' );
		...
		<label for="_timeline_styles_container_excerpt_styles[color]">
...
add_action( 'cmb2_render_container_excerpt_styles', 'timeline_express_container_excerpt_styles', 10, 5 );
 ...
 * @since 1.0.0
 */
function timeline_express_sanitize_container_excerpt_styles( $override_value, $value ) {
...
add_filter( 'cmb2_sanitize_container_excerpt_styles', 'timeline_express_sanitize_container_excerpt_styles', 10, 2 );
