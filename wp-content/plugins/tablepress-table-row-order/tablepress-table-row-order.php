...
Plugin URI: https://tablepress.org/extensions/table-row-order/
...
class TablePress_Row_Order {
	 ...
	 */
	public static function turn_off_caching( $render_options, $table ) {
	 ...
	 */
	public static function row_order_after_evaluate_processing( $table, $orig_table, $render_options ) {
	 ...
	 * @return array Modified table.
	 */
	public static function row_order_after_render_processing( $table, $orig_table, $render_options ) {
